...
class MentionResponder(commands.Cog):
    def __init__(self, bot):
        ...
        self.keyword_responses = {
            ...
            r"\b(status|server)\b": (
                "Curious if the servers are on fire? Use the `!status` command to find out!"
            ),
            r"\b(help|commands)\b": (
                "I have a lot of tools! Try typing `/scanz_commands` to see what I can do."
            ),
            r"\b(hello|hi|hey|greetings)\b": (
                "Greetings, starfarer! Hope your journeys in the verse have been profitable."
            ),
        }
        ...
        self.fallback_responses = [
            ...
            "If you're looking for a group, don't forget you can use the `/post` command "
            "in the LFG channels!",
        ]
