...
class StarCitizen(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.status_api_url = "https://status.robertsspaceindustries.com/static/content/api/v0/systems.en.json"
    ...
    async def org(self, ctx):
        ...
        embed.set_thumbnail(url="https://robertsspaceindustries.com/media/893950u2677hir/heap_infobox/SCANZ-Logo-2020.png") # Placeholder or real logo if available
        
        embed.add_field(name="RSI Org Page", value="[SCANZ on RSI](https://robertsspaceindustries.com/orgs/SCANZ)", inline=False)
