    ...
    async def suggestion(self, interaction: discord.Interaction, text: str, anonymous: bool = False):
        ...
        if anonymous:
            embed.set_author(
                ...
                icon_url="https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y",
            )
        ...
        try:
            ...
            if author:
                embed = discord.Embed(
                    ...
                    description=(
                        f"Someone has replied to the discussion thread for your suggestion in "
                ...
                embed.add_field(
                    name="Link", value=f"[Click here to view the reply]({message.jump_url})", inline=False
                )
